...
fprintf('\n HCP Unit Cell - Tetrahedral Voids\n');
fprintf(' Lattice: a = 1, c = 1.633a, Atoms/cell: 2, CN: 12, Packing: 74%%\n');
fprintf(' Tetrahedral voids: 4/cell, r/R = 0.225\n');
...
figure('Name', 'HCP - Tetrahedral Voids', 'Position', [250, 100, 700, 600], 'Color', 'w');
hold on;

for i = 1:size(hcp_atoms, 1)
    draw_sphere(hcp_atoms(i,:), atom_radius, atom_color, 1.0, sphere_quality);
end
...
setup_3d_view('HCP Unit Cell - Tetrahedral Voids');
