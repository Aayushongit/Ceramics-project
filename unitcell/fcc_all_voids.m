...
fprintf('\n FCC Unit Cell - All Interstitial Voids\n');
fprintf(' Lattice: a = 1, Atoms/cell: 4, CN: 12, Packing: 74%%\n');
fprintf(' Octahedral: 4/cell (r/R=0.414), Tetrahedral: 8/cell (r/R=0.225)\n');
...
figure('Name', 'FCC - All Voids', 'Position', [150, 100, 700, 600], 'Color', 'w');
hold on;

for i = 1:size(fcc_atoms, 1)
    draw_sphere(fcc_atoms(i,:), atom_radius, atom_color, 0.7, sphere_quality);
end
...
setup_3d_view('FCC Unit Cell - All Interstitial Voids');
