...
fprintf('\n HCP Unit Cell - Octahedral Voids\n');
fprintf(' Lattice: a = 1, c = 1.633a, Atoms/cell: 2, CN: 12, Packing: 74%%\n');
fprintf(' Octahedral voids: 2/cell, r/R = 0.414\n');
...
figure('Name', 'HCP - Octahedral Voids', 'Position', [200, 100, 700, 600], 'Color', 'w');
hold on;
...
setup_3d_view('HCP Unit Cell - Octahedral Voids');
